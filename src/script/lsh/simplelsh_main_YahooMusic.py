...
parser.add_argument('--data', default="/amax/home/zhangjin/scann+/julia/data/YahooMusic/items.npy", type=str, help='path of datafile')
parser.add_argument('--queries', default='/amax/home/zhangjin/scann+/julia/data/YahooMusic/queries.npy', type=str, help='path of datafile')
parser.add_argument('--true_neighbors_top100', default='/amax/home/zhangjin/scann+/julia/data/YahooMusic/true_neighbors_top100.npy', type=str, help='path of datafile')
