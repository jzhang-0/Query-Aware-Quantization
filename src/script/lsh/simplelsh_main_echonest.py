...
# data number: 260417
parser.add_argument('--data', default='data/echonestdata/echonestdata_items.npy', type=str, help='path of datafile')
parser.add_argument('--queries', default='data/echonestdata/queries.npy', type=str, help='path of datafile')
parser.add_argument('--true_neighbors_top100', default='data/echonestdata/true_neighbors_top100.npy', type=str, help='path of datafile')
