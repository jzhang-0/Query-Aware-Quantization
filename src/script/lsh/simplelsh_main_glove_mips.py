...
parser.add_argument('--data', default='data/glove_mips/glove.npy', type=str, help='path of datafile')
parser.add_argument('--queries', default='data/glove_mips/queries_test.npy', type=str, help='path of datafile')
parser.add_argument('--true_neighbors_top100', default='data/glove_mips/tr100_test.npy.npy', type=str, help='path of datafile')
